    ...
    <div className={`${shell.page} ${styles.aboutPage}`}>
      ...
      <main id="inhalt">
        ...
        <section className={styles.paths}>
          ...
          <div className={styles.pathGrid}><article><p>01 · EIN KONKRETER PUNKT</p><h3><span>Klarheits-</span><span>sitzung</span></h3><span>Für ein konkretes Thema, bei dem du gerade feststeckst und jetzt weiterkommen willst. Du erkennst wieder, was für dich wirklich stimmig ist, und gehst mit einem nächsten Schritt aus der Sitzung, mit dem du selbstständig weitergehen kannst.</span><ActionLink href="/klarheitssitzung">ZUR KLARHEITSSITZUNG</ActionLink></article><article><p>02 · SECHS MONATE</p><h3><span className={styles.really}>Wirklich</span> <em>Deins.</em></h3><span>Für das, was du in deinem Leben verändern, aufbauen oder verwirklichen möchtest. Über sechs Monate richtest du dich immer wieder daran aus, triffst deine Entscheidungen von dort aus und gehst konkrete Schritte, die für dich stimmig sind.</span><ActionLink href="/wirklich-deins" light>WIRKLICH DEINS. ENTDECKEN</ActionLink></article></div>
        </section>
      </main>

      <footer className={`${shell.footer} ${siteStyles.siteFooter}`}><a className={shell.footerBrand} href="#top"><strong>Petra Sailer</strong><span>Dem Eigenen folgen</span></a><nav aria-label="Footer-Navigation"><a href="#top">ÜBER MICH</a><a href="/klarheitssitzung">KLARHEITSSITZUNG</a><a href="/wirklich-deins">WIRKLICH DEINS.</a><a href="/kontakt">KONTAKT</a><a href="/arbeite-mit-mir">ARBEITE MIT MIR</a></nav><a className={shell.footerEmail} href="mailto:kontakt@petrasailer.com">kontakt@petrasailer.com</a><div className={shell.footerBottom}><p>© Petra Sailer 2026</p><div><a href="https://petrasailer.com/impressum/">Impressum</a><a href="https://petrasailer.com/datenschutz/">Datenschutz</a></div></div></footer>
    </div>
  );
}
