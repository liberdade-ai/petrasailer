...
export default function WorkWithMePage() {
  return (
    <div className={`${shell.page} ${styles.workPage}`}>
        ...
        <section className={styles.paths} id="zusammenarbeit">
          ...
          <div className={styles.pathGrid}>
            <article className={`${styles.path} ${styles.pathOne}`}>
              ...
              <ActionLink href="/klarheitssitzung">ZUR KLARHEITSSITZUNG</ActionLink>
            </article>
            <article className={`${styles.path} ${styles.pathTwo}`}>
              ...
              <ActionLink href="/wirklich-deins" light>WIRKLICH DEINS. ENTDECKEN</ActionLink>
            </article>
          </div>
      ...
      <footer className={`${shell.footer} ${siteStyles.siteFooter}`}><a className={shell.footerBrand} href="#top"><strong>Petra Sailer</strong><span>Dem Eigenen folgen</span></a><nav aria-label="Footer-Navigation"><a href="/ueber-mich">ÜBER MICH</a><a href="/klarheitssitzung">KLARHEITSSITZUNG</a><a href="/wirklich-deins">WIRKLICH DEINS.</a><a href="/kontakt">KONTAKT</a><a href="#top" aria-current="page">ARBEITE MIT MIR</a></nav><a className={shell.footerEmail} href="mailto:kontakt@petrasailer.com">kontakt@petrasailer.com</a><div className={shell.footerBottom}><p>© Petra Sailer 2026</p><div><a href="https://petrasailer.com/impressum/">Impressum</a><a href="https://petrasailer.com/datenschutz/">Datenschutz</a></div></div></footer>
    </div>
  );
}
